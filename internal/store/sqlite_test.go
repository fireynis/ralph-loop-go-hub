...
func TestSQLite_SessionEndedUpdatesStatus(t *testing.T) {
	s := newTestSQLite(t)
	ctx := context.Background()
...
func TestSQLite_IterationHistoryLimit(t *testing.T) {
	s := newTestSQLite(t)
	ctx := context.Background()
...
func TestSQLite_GetSessions(t *testing.T) {
	s := newTestSQLite(t)
	ctx := context.Background()
...
func TestSQLite_GetSessionDetail(t *testing.T) {
	s := newTestSQLite(t)
	ctx := context.Background()
...
func TestSQLite_GetSessionDetail_NotFound(t *testing.T) {
	s := newTestSQLite(t)
	ctx := context.Background()
...
func TestSQLite_GetAggregateStats(t *testing.T) {
	s := newTestSQLite(t)
	ctx := context.Background()
